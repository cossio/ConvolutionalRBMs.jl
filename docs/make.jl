...
ENV["JULIA_DEBUG"] = "Documenter,Literate,ConvolutionalRBMs"
...
=#
Documenter.makedocs(
    modules = [ConvolutionalRBMs],
    sitename = "ConvolutionalRBMs.jl",
    pages = [
        "Home" => "index.md",
        "Examples" => [
            "MNIST conv" => "literate/MNIST_conv.md",
            "MNIST dense" => "literate/MNIST_dense.md",
        ],
...
Documenter.deploydocs(
    repo = "github.com/cossio/ConvolutionalRBMs.jl.git",
    devbranch = "master"
)
